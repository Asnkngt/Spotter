...
public class ImageStorage {
    ...
    public static void Clear(){
        ...
        Log.d(TAG, "Clear: Running Clearer"+groups.length);
        for(String group:groups){
            String[] nameList= GetNamesFromGroup(group);
            Log.d(TAG, "Clear: "+group+nameList.length);
            for(String name: nameList){
                Log.d(TAG, "Clear: "+name);
                String[] ids=GetIDsFromName(name);
                for(String id:ids){
                    Log.d(TAG, "Clear: "+id);
                    File toBeDeleted=new File(id);
                    toBeDeleted.delete();
                }
            }
        }
    ...
    //o=false
    //1=true
    public static void LoadNamesFromGroup(String group){
    ...
    public static String[] GetNamesFromGroup(String group){
        ArrayList<String> listNames=new ArrayList<String>();
